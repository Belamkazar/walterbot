...
const keywordResponses = {
  ...
  'clave': [
    ['Mensaje 1', 2000], // Mensaje 1 con un intervalo de 2000 ms (2 segundos) antes del siguiente mensaje
    ['Mensaje 2', 1000], // Mensaje 2 con un intervalo de 1000 ms (1 segundo) antes del siguiente mensaje
    ['Mensaje 3', 3000], // Mensaje 3 con un intervalo de 3000 ms (3 segundos) antes del siguiente mensaje
    ['Mensaje 4', 1500], // Mensaje 4 con un intervalo de 1500 ms (1.5 segundos) antes del siguiente mensaje
    ['Mensaje 5', 2000], // Mensaje 5 con un intervalo de 2000 ms (2 segundos) antes del siguiente mensaje
    ['Mensaje 6', 1000], // Mensaje 6 con un intervalo de 1000 ms (1 segundo) antes del siguiente mensaje
  ],
  // Agrega más palabras clave y sus respuestas aquí
  'otra': [
    ['Respuesta 1', 3000], // Respuesta 1 con un intervalo de 3000 ms (3 segundos) antes del siguiente mensaje
    ['Respuesta 2', 2000], // Respuesta 2 con un intervalo de 2000 ms (2 segundos) antes del siguiente mensaje
    ['Respuesta 3', 2500], // Respuesta 3 con un intervalo de 2500 ms (2.5 segundos) antes del siguiente mensaje
  ],
};
